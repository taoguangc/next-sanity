    ...
    <section className="py-40">
      <div className="container mx-auto flex flex-row flex-wrap gap-y-8 px-4 lg:gap-y-16 lg:px-8">
        <div className="flex w-1/2 flex-row items-end xl:w-1/4">
          <h2 className="text-stroke text-white mr-2 text-5xl font-extrabold tracking-tighter md:text-7xl xl:text-8xl">15</h2>
        ...
        <div className="flex w-1/2 flex-row items-end xl:w-1/4">
          <h2 className="text-stroke text-white mr-2 text-5xl font-extrabold tracking-tighter md:text-7xl xl:text-8xl">100</h2>
